...
@Service("dealEventReceiveRetryTask")
@Slf4j
public class DealEventReceiveRetryTask extends ScheduleTaskDealAbstract{

    @Autowired
    EventRetry defaultReceiveRetryExecutor;
    ...
    public boolean execute(ScheduleServer scheduleServer) {
        ...
        try {
            ...
            RetryStatistics statistics = defaultReceiveRetryExecutor.retry(pageSize,eventStatusList);
